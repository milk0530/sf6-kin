export default async function handler(req, res) {
  ...
  try {
    const url = `https://www.streetfighter.com/6/buckler/ranking?page=${page}`;
    ...
    return res.json({
      list:         pageProps.ranking_list ?? [],
      current_page: pageProps.current_page ?? page,
      total_page:   pageProps.total_page ?? 1,
    });
  } catch (e) {
